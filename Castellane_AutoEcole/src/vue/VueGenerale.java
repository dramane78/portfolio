...
public class VueGenerale extends JFrame implements ActionListener {
    ...
    public VueGenerale() {
        ...
        // --- Titre ---
        JLabel lbTitre = new JLabel("CASTELLANE Auto Ecole");
        lbTitre.setBounds(380, 10, 300, 30);
        lbTitre.setForeground(Color.white);
        this.add(lbTitre);

        // --- Menu ---
        this.panelMenu.setBounds(10, 10, 340, 40);
        ...
        // --- Bouton Quitter ---
        this.btQuitter.setBounds(880, 10, 90, 35);
